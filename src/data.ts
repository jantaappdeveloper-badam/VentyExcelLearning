...
export const TUTORIAL_CHALLENGES: Challenge[] = [
  {
    ...
    sheetId: "prospek",
    title: "1. Hitung Usia (Kolom D) - DATEDIF Lintas Sheet",
    description: "Ambil tanggal lahir dari sheet DATA_NOMINATIF untuk menghitung usia debitur di kolom Usia (Kolom D).",
    ...
    successMessage: "Sempurna! Usia debitur berhasil dikalkulasi dari data referensi eksternal sheet DATA_NOMINATIF.",
    completed: false
  },
  {
    ...
    windowId: "prospek_under_100jt",
    sheetId: "prospek",
    title: "2. Hitung Rasio % Potongan (Kolom J)",
    description: "Masukkan rumus pembagian angsuran terhadap pendapatan di kolom % Potongan (Kolom J).",
  ...
  },
  {
    ...
    windowId: "prospek_under_100jt",
    sheetId: "prospek",
    title: "3. Tentukan Status Potongan (Kolom K) - IF",
    description: "Evaluasi apakah rasio potongan > 90% (DSR limit) di kolom Status Potongan (Kolom K).",
  ...
  },
  {
    ...
    windowId: "prospek_under_100jt",
    sheetId: "prospek",
    title: "4. Evaluasi Skala Prioritas (Kolom N) - AND & IF",
    description: "Saring prioritas pemasaran kredit mikro di bawah 100 juta yang berkolektibilitas lancar di kolom SKALA PRIORITAS (Kolom N).",
  ...
  },
  {
    ...
    sheetId: "pegawai_bup",
    title: "5. Hitung Umur Debitur (Kolom G) - DATEDIF",
    description: "Hitung umur debitur saat ini berdasarkan tanggal lahir di kolom Umur (Kolom G).",
  ...
  },
  {
    ...
    windowId: "pegawai_plus_bup",
    sheetId: "pegawai_bup",
    title: "6. Hitung Tanggal BUP (Kolom I) - DATE & YEAR",
    description: "Hitung tepat tanggal lahir + 58 tahun pensiun di kolom Tgl BUP (Kolom I).",
  ...
  },
  {
    ...
    windowId: "pegawai_plus_bup",
    sheetId: "pegawai_bup",
    title: "7. Hitung Sisa Masa Dinas (Kolom J)",
    description: "Hitung berapa tahun sisa dinas pegawai sebelum masuk masa pensiun di kolom Sisa Masa Dinas (Kolom J).",
  ...
  },
  {
    ...
    windowId: "pegawai_plus_bup",
    sheetId: "pegawai_bup",
    title: "8. Tentukan Skema Pegawai Plus (Kolom K)",
    description: "Klasifikasikan skema Pegawai Plus berdasarkan sisa masa dinas di kolom Propek Untuk Kredit (Kolom K).",
  ...
  },
  {
    ...
    windowId: "pegawai_plus_bup",
    sheetId: "pegawai_bup",
    title: "9. Tentukan Kelayakan Prospek (Kolom N) - IF",
    description: "Cek apakah debitur BISA melakukan jaminan Pegawai Plus di kolom Prospek (Kolom N) (Bakidebet Juni <= 100 Juta).",
